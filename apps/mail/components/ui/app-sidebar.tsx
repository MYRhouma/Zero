  ...
  return (
    <Dialog open={!!dialogOpen} onOpenChange={handleOpenChange}>
      ...
      <DialogTrigger asChild>
        <button type="button" className="relative mb-1.5 inline-flex h-8 w-full items-center justify-center gap-1 self-stretch overflow-hidden rounded-lg border border-[#397b7b]/30 bg-[#397b7b] text-black dark:border-none dark:text-white cursor-pointer hover:bg-[#2e6666] dark:hover:bg-[#2e6666] transition-colors">
